...
The following essays offer entry points into ecomimetic design for readers coming from different backgrounds. They are intentionally accessible — written for the curious generalist as much as the specialist.
...
One of the most valuable contributions a practitioner can make is thorough documentation of a project as it unfolds over time. The resources collected here show ecomimetic design in practice — not the polished final state, but the process: the dead ends, the surprises, the outcomes that only emerged years later.
...
A growing archive of recorded conversations between practitioners, ecologists, and thinkers working at the edge of what ecomimetic design can become. These conversations are unedited and long-form — intended for deep listening, not quick consumption.
